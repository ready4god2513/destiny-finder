		...
		<div class="span11">
			<section id="main">
				...
				<cfif REQUEST.user_id EQ 0>
					<cfset VARIABLES.action_url = "/auth/?page=user&create=1">
				<cfelse>
					<cfset VARIABLES.action_url = "/auth/account/settings/">
				</cfif>
				...
				<div class="box">
					...
					<form action="<cfoutput>#VARIABLES.action_url#</cfoutput>" method="POST" id="<cfoutput>#form_name#</cfoutput>">
						<fieldset>
							<div class="clearfix">
