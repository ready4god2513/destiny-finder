...
<cffunction name="process_results" hint="I process an assessment result set" output="true">
    ...
    Select 
    <cfif assessment_id GT 2>gift_primary<cfelse>gift_brief</cfif> AS ThisResult from gifts
    Where gift_id = #VARIABLES.dominant_gift.id#
    </cfquery>
    ...
    <div style="margin: 70px 0px 0px 100px; color: ##a82b33; font-size: 18px; font-weight: bold">Destiny Survey Result - #qUser.user_first_name# #qUser.user_last_name# #dateformat(qResult.last_modified,'mmm dd, yyyy')#</div>
