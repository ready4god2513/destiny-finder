	...
	<cfswitch expression="#process#">
		...
		<cfcase value="Create Account">	
				...
				<cfelse>
					...
					<cfquery name="Insert_Store_User" datasource="#APPLICATION.STORE_DSN#">
							INSERT INTO users 
								(username,password,email,emailisbad,emaillock,subscribe,Customer_ID,ShipTo,Group_ID,Account_ID,Created,LastLogin,Permissions)
								VALUES
								('#FORM.user_email#','#FORM.user_password#','#FORM.user_email#','FALSE','verified',0,0,0,8,0,<cfqueryparam cfsqltype="CF_SQL_TIMESTAMP" value="#Now()#">,<cfqueryparam cfsqltype="CF_SQL_TIMESTAMP" value="#Now()#">,'registration^11')
					</cfquery>
