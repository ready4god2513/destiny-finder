...
<form name="form<cfoutput>#VARIABLES.vCount#</cfoutput>" action="act_passion_survey.cfm" class="survey-form" method="post" id="sort_form_<cfoutput>#ATTRIBUTES.sort_id#</cfoutput>">
	<div class="controls">
		<div class="inputs-list">
			<li><label><input name="area" type="radio" value="inner city">Inner City </label>
			<li><label><input name="area" type="radio" value="urban">Urban </label>
			<li><label><input name="area" type="radio" value="suburban">Suburban </label>
			<li><label><input name="area" type="radio" value="undecided">Undecided </label>
		</div>
	</div>
