...
<form name="form<cfoutput>#VARIABLES.vCount#</cfoutput>" action="act_passion_survey.cfm" class="survey-form" method="post" id="sort_form_<cfoutput>#ATTRIBUTES.sort_id#</cfoutput>">
	<div class="input">
		<ul class="inputs-list">
			<li><label><input type="checkbox" name="government_legal" value="Political Office and Campaigning">Political Office and Campaigning</label></li>
			<li><label><input type="checkbox" name="government_legal" value="Military Service">Military Service</label></li>
			<li><label><input type="checkbox" name="government_legal" value="Civil Service">Civil Service</label></li>
			<li><label><input type="checkbox" name="government_legal" value="Law Enforcement">Law Enforcement</label></li>
		</ul>
	</div>
