...
<form name="form<cfoutput>#VARIABLES.vCount#</cfoutput>" action="act_passion_survey.cfm" class="survey-form" method="post" id="sort_form_<cfoutput>#ATTRIBUTES.sort_id#</cfoutput>">
	<div class="input">
		<ul class="inputs-list">
			<li><label><input type="radio" name="organizational_type" value="Self-employed">Self-employed</label></li>
			<li><label><input type="radio" name="organizational_type" value="Pioneer / Start-up">Pioneer / Start-up </label></li>
			<li><label><input type="radio" name="organizational_type" value="Small and Adaptive">Small and Adaptive</label></li>
			<li><label><input type="radio" name="organizational_type" value="Mid-sized and Growing">Mid-sized and Growing</label></li>
			<li><label><input type="radio" name="organizational_type" value="Large and Stable">Large and Stable</label></li>
		</ul>
	</div>
