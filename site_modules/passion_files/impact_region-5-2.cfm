...
<h2>I feel most drawn to impact the following country or region</h2>
        <br />
        <h3>Instructions</h3>
    ...
    <!---
    <label style="border:hidden;"><select name="selContinent">
    <option style="text-align:center;" value="" selected="selected">Select a Continent</option>
    ...
    <label><select name="selState">
    <option style="text-align:center;" value="" selected="selected">Select a State</option>
