...
<form name="form<cfoutput>#VARIABLES.vCount#</cfoutput>" action="act_passion_survey.cfm" class="survey-form" method="post" id="sort_form_<cfoutput>#ATTRIBUTES.sort_id#</cfoutput>">
	<div class="controls">
		<div class="inputs-list">
			...
			<label class="radio"><input type="radio" name="ethnicity" value="Black">Black</label>
			<label class="radio"><input type="radio" name="ethnicity" value="Hispanic">Hispanic</label>
			<label class="radio"><input type="radio" name="ethnicity" value="Asian and Pacific Islander">Asian and Pacific Islander</label>
			<label class="radio"><input type="radio" name="ethnicity" value="Middle Eastern/Arabic">Middle Eastern/Arabic</label>
			<label class="radio"><input type="radio" name="ethnicity" value="Mixed">Mixed</label>
			<label class="radio"><input type="radio" name="ethnicity" value="Any">Any</label>
			<label class="radio"><input type="radio" name="ethnicity" value="None">None</label>
		</div>
	</div>
