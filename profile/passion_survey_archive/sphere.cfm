...
<h3>Sphere</h3>
		...
		<form name="sphere" action="act_passion_survey.cfm" class="survey-form" method="post" id="">
					...
					<label><input type="radio" name="sphere" value="3">Business and Economics</label>
					<label><input type="radio" name="sphere" value="4">Government, Legal and Non-Profit</label>
					<label><input type="radio" name="sphere" value="5">Religion and Spirituality</label>
