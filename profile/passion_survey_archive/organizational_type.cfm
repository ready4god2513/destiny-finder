...
<h3>The organizational type I’m most comfortable in is:</h3>
        <br />
        
		<form action="" method="post" id="">
			
					<label><input type="radio" name="organizational_type" checked value="Self-employed">Self-employed</label>
