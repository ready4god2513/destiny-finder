...
<cfscript>
	...
	Config.UserFilesPath = "/custom_files/" ;
...
//		Attention: It must end with a slash: '/'
	...
	Config.FileTypesAbsolutePath["Image"] 	= iif( Config.ServerPath eq "", de(""), de(Config.ServerPath & '/') ) ;
	...
	Config.FileTypesAbsolutePath["Flash"] 	= iif( Config.ServerPath eq "", de(""), de(Config.ServerPath & '/') ) ;
	...
	Config.FileTypesAbsolutePath["Media"] 	= iif( Config.ServerPath eq "", de(""), de(Config.ServerPath & '/') ) ;
