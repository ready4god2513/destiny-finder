<cfquery name="qBlogs" datasource="#APPLICATION.DSN#" maxrows="12">
	SELECT Blogs.blog_id,Blogs.blog_title,Blogs.blog_publish_date,Blogs.blog_shorttext,Blogs.blog_facebook
...
<cfoutput>
	<channel>
		...
		<cfloop query="qBlogs">
			<cfif LEN(qBlogs.blog_facebook) GT 0>
				<cfset VARIABLES.description_text = qBlogs.blog_facebook>
				<item>
...
<cffile action="write"
    file="#REQUEST.site_path#facebook_feed.xml"
