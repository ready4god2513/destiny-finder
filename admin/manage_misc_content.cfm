<!--- QUERY FOR LISTING --->
<cfquery name="gethomeblocks" datasource="#APPLICATION.DSN#" dbtype="odbc">
	SELECT block_id, block_title FROM MiscContent
...
<title>Misc Content Management</title>
...
<div style="width:500px;margin-right:auto;margin-left:auto;margin-top:5px;">
	...
	<cfoutput query="gethomeblocks">
		<div id="<cfif currentrow MOD 2>even_row<cfelse>odd_row</cfif>">
			...
			<div id="name_column" style="width:100%"><a href="misc_content_block.cfm?block_id=#gethomeblocks.block_id#"><img src="images/edit.gif" />&nbsp;#gethomeblocks.block_title#</a></div>
			<div style="clear:both;"></div>
		</div>
	</cfoutput>	
<div style="clear:both;"></div>
