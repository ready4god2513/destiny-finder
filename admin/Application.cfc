<cfcomponent output="false">
	...
	<!---<cfif NOT FindNoCase("68.229.193.96|75.140.100.15",cgi.REMOTE_ADDR)>
    <html>
    <head>
    <title></title>
    </head>
    ...
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p align="center" style="color: #0066CC;font-size:22px;">
    	This section of the Web site is currently undergoing modification.<br>
        <br>
        <em>~ The DestinyFinder Development Team</em>
    </p>
    </body>
    </html>
    <cfabort>
	...
	<cfset this.name = "destinyfinderdev_admin">
	...
	<cfset APPLICATION.webadmin_ip = "68.12.182.158|75.140.100.15">
...
<!--- Run when application stops --->
	...
	<cffunction name="onRequestStart" returnType="boolean" output="false">
		...
		<cfset APPLICATION.contact_email = "paul@webvisionhosting.com">
		
		<!--- BLOG STUFF --->
		<cfset REQUEST.time_offset = 2>
		<cfset REQUEST.from_email = "">
	...
	<cfif FIND(CGI.REMOTE_ADDR,APPLICATION.webadmin_ip)>
		...
		<cfelse>
			<cfmail to="#APPLICATION.webadmin_email#" from="#APPLICATION.webadmin_email#" subject="Error Report From: #APPLICATION.sitename#" type="html">
				<cfdump var="#arguments#">
			</cfmail>
			<cfmodule template="/templates/error_message.cfm">
		</cfif>
