...
>
	...
	<tr>
		<td align="center" valign="top" width="125"><img src="#Request.AppSettings.defaultimages#/icons/fedex_sm.gif" alt="" width="130" height="49" border="0" /></td><td colspan="2"><br/>To track an order, please enter the order number
...
<tr align="left"><td width="50"><br/><cfoutput><img src="#Request.AppSettings.defaultimages#/icons/fedex_sm.gif" alt="" width="130" height="50" border="0" align="left" /></cfoutput></td><td colspan="3"><br/>
