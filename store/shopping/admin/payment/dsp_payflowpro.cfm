...
<cfoutput>
		...
		<tr>
			...
			<td style="background-color: ###Request.GetColors.formreq#;"></td>
			<td>
			<input type="text" name="Setting2" value="#attributes.Setting2#" size="30" maxlength="75" class="formfield"/>
			</td>	
		</tr>
		
		<tr>
			<td align="RIGHT">Path to certificate </td>
			<td style="background-color: ###Request.GetColors.formreq#;"></td>
			<td>
			<input type="text" name="Setting3" value="#attributes.Setting3#" size="30" maxlength="75" class="formfield"/>
			</td>	
		</tr>
