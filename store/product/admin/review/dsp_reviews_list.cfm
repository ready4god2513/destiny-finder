...
<cfif qry_get_reviews.recordcount gt 0>					
	<cfloop query="qry_get_reviews" startrow="#PT_StartRow#" endrow="#PT_EndRow#">
		<tr>
			...
			<td colspan="2">
				<a href="#self#?fuseaction=product.reviews&do=display&Review_ID=#Review_ID##request.token2#" target="store"><strong>#LEFT(title, 27)#</strong></a><br/>
				
			#dateformat(posted,"mm/dd/yy")# &nbsp; <a href="#self#?fuseaction=product.display&product_ID=#product_ID##request.token2#" target="store">#LEFT(product_Name, 30)#</a>
				
			</td>			

			
			<td>
			<img src="#request.appsettings.defaultimages#/icons/#Rating#_med_stars.gif" alt="" /><br/>
