...
<cfelse>
	...
	<cfif FindNoCase(".admin", redirectURL) AND NOT attributes.menu_reload>
		location.href = '#redirectURL#&inframes=yes';
	...
	<a href="#redirectURL#" <cfif NOT FindNoCase(".admin", redirectURL) OR attributes.menu_reload>target="_top"</cfif>Click</a> to continue. 
	</cfoutput>
